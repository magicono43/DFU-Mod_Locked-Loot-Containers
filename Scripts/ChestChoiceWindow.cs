    ...
    public class ChestChoiceWindow : DaggerfallPopupWindow
    {
        ...
        private void AttemptLockpickButton_OnMouseClick(BaseScreenComponent sender, Vector2 position)
        {
            ...
            if (chest != null)
            {
                ...
                {
                    LockedLootContainersMain.CreateScreenWrappedHudText(LockedLootContainersMain.TextTokenFromRawString(LockedLootContainersMain.GetLockAlreadyJammedText()), 2f);
                ...
                else if (LockedLootContainersMain.LockPickChance(chest))
                {
                    ...
                    LockedLootContainersMain.CreateScreenWrappedHudText(LockedLootContainersMain.TextTokenFromRawString(LockedLootContainersMain.GetLockPickSuccessText()));
                ...
                else
                {
                    ...
                    {
                        LockedLootContainersMain.CreateScreenWrappedHudText(LockedLootContainersMain.TextTokenFromRawString(LockedLootContainersMain.GetJammedLockText()));
                        if (dfAudioSource != null)
                    ...
                    {
                        LockedLootContainersMain.CreateScreenWrappedHudText(LockedLootContainersMain.TextTokenFromRawString(LockedLootContainersMain.GetLockPickAttemptText()), 2f);
                        if (dfAudioSource != null && !dfAudioSource.IsPlaying())
            ...
            {
                LockedLootContainersMain.CreateScreenWrappedHudText(LockedLootContainersMain.TextTokenFromRawString("ERROR: Chest Was Found As Null."));
            }
        }
